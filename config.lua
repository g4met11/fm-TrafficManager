...
>>>>>>> dc45cea58d0dc483b28639fa22f4ceaf5d4e52c8

config.BlipAlpha = 80 -- 0 - 100
config.BlipColorSlow = 5 -- Check https://docs.fivem.net/docs/game-references/blips/ for a color
config.BlipColorStop = 1 -- Check https://docs.fivem.net/docs/game-references/blips/ for a color

config.SlowSpeedZone = 5.0 -- Speed on the car in a slow zone

config.UseKeybind = 'esx' -- 'qb', 'esx', nil - Means no use
config.Keybind = 'F9'

<<<<<<< HEAD
config.Watermark = true -- Watermark in console
=======
